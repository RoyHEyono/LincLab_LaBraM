...
def main(args):
    ...
    # ]
    datasets_train = [["/network/scratch/q/qingchen.hu/eeg_processed/alexeeg_selected.hdf5"],
    ["/network/scratch/q/qingchen.hu/eeg_processed/physionetMI_selected.hdf5"]]
    ...
    dataset_train_list, train_ch_names_list = utils.build_pretraining_dataset(datasets_train, time_window, stride_size=800, 
